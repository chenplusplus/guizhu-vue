...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'order/factory-edit/:id', name: 'FactoryEdit', component: () => import('@/views/order/factory-edit.vue'), meta: { title: '编辑订单' } },
      ...
      { path: 'order/import', name: 'OrderImport', component: () => import('@/views/order/import.vue'), meta: { title: '导入Excel' } },
      
      // 退货记录
      { path: 'order/returns', name: 'ReturnList', component: () => import('@/views/order/return-list.vue'), meta: { title: '退货记录', icon: '↩️' } },
      
      // 账单统计
      { path: 'bill/stats', name: 'BillStats', component: () => import('@/views/order/bill-stats.vue'), meta: { title: '账单统计', icon: '📊' } },
      ...
      { path: 'order/bill/detail/:id', name: 'BillDetail', component: () => import('@/views/order/bill-detail.vue'), meta: { title: '账单详情' } },
      { path: 'order/lr/edit/:billId', name: 'LrEditor', component: () => import('@/views/order/lr-editor.vue'), meta: { title: 'LR表编辑', icon: '📊', roles: ['factoryOrder', 'admin'] } },
      { path: 'order/lr/list', name: 'LrList', component: () => import('@/views/order/lr-list.vue'), meta: { title: 'LR表管理', icon: '📊' } },
      // router/index.js - 添加 bill-edit 支持无 id 参数（新建模式）
      {
        path: 'order/bill/edit/:id?',  // ⭐ 改为可选参数
        name: 'BillEdit',
      ...
      { path: 'system/gold-price', name: 'GoldPrice', component: () => import('@/views/system/gold-price.vue'), meta: { title: '金价管理', roles: ['admin'] } },
      { path: 'system/diamond-price', name: 'DiamondPrice', component: () => import('@/views/system/diamond-price.vue'), meta: { title: '钻石价格', roles: ['admin'] } },
      { path: 'system/operation-log', name: 'OperationLog', component: () => import('@/views/system/operation-log.vue'), meta: { title: '操作日志', roles: ['admin'] } },
      
      // ===== 总进出模块 =====
      { path: 'inout/list', name: 'InoutList', component: () => import('@/views/inout/list.vue'), meta: { title: '总进出管理', icon: '💰' } },
      { path: 'inout/create', name: 'InoutCreate', component: () => import('@/views/inout/create.vue'), meta: { title: '总进出录入', icon: '📝' } },
      { path: 'inout/detail/:id', name: 'InoutDetail', component: () => import('@/views/inout/detail.vue'), meta: { title: '总进出详情', icon: '📄' } },
    ],
  },
];
