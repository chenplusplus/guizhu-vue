  ...
  <div class="page-container" v-loading="loading">
    <div class="page-header">
      ...
      <div class="header-right">
        <el-button type="primary" @click="$router.push('/process/xs-input')"><el-icon><Plus /></el-icon> 录入</el-button>
...
const dateRange = ref([]);
const searchForm = reactive({ keyword: '', materialId: null, status: null, startDate: '', endDate: '' });
...
const loadData = async () => {
  loading.value = true;
  try {
    const res = await getProcessList({ mainProcess: 'XS', keyword: searchForm.keyword || undefined, materialId: searchForm.materialId || undefined, status: searchForm.status ?? undefined, startDate: searchForm.startDate || undefined, endDate: searchForm.endDate || undefined, page: pagination.current, pageSize: pagination.pageSize });
